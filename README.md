...
JavaScript: Core functionality, updating preview in real-time.

## Usage
Open the HTML, CSS, or JavaScript panel to type your code.
The live preview window updates automatically.
Use the reset button to clear all panels and start fresh.
